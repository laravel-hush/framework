window.functions = class functions {
    static initialize() {
        ...
        tinymce.init({
            ...
            plugins: 'autolink code fullscreen image imagetools link lists media table',
            toolbar: 'undo redo removeformat | styleselect | bold italic | alignleft aligncenter alignright alignjustify | numlist bullist | blockquote link table image media code | fullscreen',
